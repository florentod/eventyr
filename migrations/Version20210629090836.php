 ...
 */
final class Version20210629090836 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE offers (id INT AUTO_INCREMENT NOT NULL, country_id INT DEFAULT NULL, offer_name VARCHAR(255) NOT NULL, offer_type VARCHAR(255) NOT NULL, offer_hosting VARCHAR(255) NOT NULL, offer_difficulty VARCHAR(255) NOT NULL, offer_description LONGTEXT NOT NULL, offer_map_photo VARCHAR(255) NOT NULL, offer_start_photo VARCHAR(255) NOT NULL, type_hosting VARCHAR(255) NOT NULL, description_hosting VARCHAR(255) NOT NULL, type_food VARCHAR(255) NOT NULL, description_food LONGTEXT NOT NULL, start_point VARCHAR(255) NOT NULL, end_point VARCHAR(255) NOT NULL, recap LONGTEXT NOT NULL, brief LONGTEXT NOT NULL, INDEX IDX_DA460427F92F3E70 (country_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
